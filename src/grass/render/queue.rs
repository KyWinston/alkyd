use bevy::{
    ...
    pbr::{
        ...
        ExtractedPointLight, LightEntity, MaterialPipeline, MaterialPipelineKey, MeshPipelineKey,
        PreparedMaterial, PrepassPipeline, RenderMaterialInstances, RenderMeshInstanceFlags,
        RenderMeshInstances, Shadow, ShadowBinKey, ViewLightEntities, VisibleMeshEntities,
    },
    prelude::*,
    render::{
...
pub fn queue_grass_shadows(
    ...
    for (entity, view_lights) in &view_lights {
        ...
        for view_light_entity in view_lights.lights.iter().copied() {
            ...
            if !grass_config
                .grass_shadows
                .light_enabled(match light_entity {
