...
fn fragment(
    ...
    let varience = snoise2(in.world_position.xy);
    pbr_input.world_normal = fns::prepare_world_normal(
        apply_hue(in.world_normal, voronoise(mix(in.world_position.xy, snoise2(in.world_position.xy), material.brush_distortion), material.brush_angle, material.brush_blur)),
        double_sided,
        is_front
    );
