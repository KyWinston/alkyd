// use super::{TexGenWorker, VoronoiWorker};
// use crate::materials::painterly::resources::VoronoiImage;
// use bevy::prelude::*;
...
//     mut load_ev: EventReader<LoadPattern>,
//     mut compute_worker: ResMut<AppComputeWorker<TexGenWorker>>,
// ) {
//     for _ in load_ev.read() {
//         compute_worker.execute();
//     }
