use bevy::prelude::*;
use sickle_ui::{dev_panels::{hierarchy::UiHierarchyExt, scene_view::{SceneView, UiSceneViewExt}}, prelude::*, ui_commands::{SetCursorExt, UpdateStatesExt}};

use super::{
    components::{ExitAppButton, HierarchyPanel, Page, ShowcaseContainer, ThemeContrastSelect, ThemeSwitch, UiCamera, UiMainRootNode}, UiOutlinedBlockExt, UiTextureAtlasInteractionExt, UiFooterRootNodeExt
};
...
pub fn interaction_showcase(root_node: Query<Entity, With<ShowcaseContainer>>, mut commands: Commands) {
    let root_entity = root_node.single();
