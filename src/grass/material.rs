...
use super::render::instance::GrassInstanceData;
...
impl AsBindGroupShaderType<GrassMaterialUniform> for GrassMaterialExtension {
    fn as_bind_group_shader_type(&self, _images: &RenderAssets<GpuImage>) -> GrassMaterialUniform {
