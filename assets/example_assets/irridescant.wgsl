...
struct IrridescantMaterial {
    ior: f32
}

@group(2) @binding(100)
var<uniform> my_extended_material: IrridescantMaterial;
...
fn fragment(
    ...
    let color_noise = apply_hue(hsv2rgb(vec3(snoise(in.world_position.xyz * facing * 0.2), 1.0, 1.0)), fresnel);
